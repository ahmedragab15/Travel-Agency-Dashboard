    ...
    <main className="dashboard wrapper">
      ...
      <section className="container">
        ...
        <div className="trip-grid">
          {allTrips.slice(0, 4).map(({ id, name, imageUrl, itinerary, tags, estimatedPrice, travelStyle }) => (
            <TripCard key={id} id={id.toString()} name={name} imageUrl={imageUrl} itinerary={itinerary} tags={tags} estimatedPrice={estimatedPrice} travelStyle={travelStyle} />
          ))}
        </div>
      </section>
    </main>
