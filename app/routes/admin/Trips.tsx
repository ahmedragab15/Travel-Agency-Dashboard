...
const Trips = ({ loaderData }: Route.ComponentProps) => {
  const { trips, total } = loaderData as { trips: Trip[] | []; total: number };
  ...
  return (
    <main className="all-users wrapper">
      ...
      <section>
        ...
        <PagerComponent totalRecordsCount={total} pageSize={8} currentPage={currentPage} click={(args) => handlePageChange(args.currentPage)} cssClass="!mb-4" />
      </section>
    </main>
  );
};
