        ...
        <ColumnsDirective>
          ...
          <ColumnDirective
            ...
            template={({ status }: UserData) => (
              <article className={cn("status-column", status === "admin" ? "bg-success-50" : "bg-light-300")}>
                <div className={cn("size-1.5 rounded-full", status === "admin" ? "bg-success-500" : "bg-gray-500")} />
                <h3
                  className={cn(
